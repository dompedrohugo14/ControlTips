...
export default function ProfitEvolution() {
    ...
    try {
      ...
      if (bets && bets.length > 0) {
        ...
        bets.forEach(bet => {
          ...
          groupedData[dateKey] += Number(bet.profit);
        });
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-6">
          ...
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h1 className="text-3xl font-bold text-yellow-500">Evolução do Lucro</h1>
          </div>
        ...
        <div className="bg-neutral-950 border border-neutral-800 rounded-xl p-8 shadow-lg">
          {loading ? (
            ...
            <>
              <div className="mb-8">
                <div className="text-sm text-neutral-400 mb-2">Lucro acumulado</div>
                <div className="text-4xl font-bold text-yellow-500">
                  R$ {data[data.length - 1]?.value.toFixed(2)}
                </div>
              </div>
              ...
              <div className="mt-8 grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-4">
                  <div className="text-sm text-neutral-400 mb-1">Lucro Máximo</div>
                  <div className="text-2xl font-bold text-green-500">
                    R$ {maxValue.toFixed(2)}
                  </div>
                </div>
                <div className="bg-neutral-900 border border-neutral-800 rounded-lg p-4">
                  <div className="text-sm text-neutral-400 mb-1">Lucro Mínimo</div>
