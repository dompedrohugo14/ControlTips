            ...
            return (
              <div key={index} className="flex-1 flex flex-col items-center gap-2">
                <div className="w-full bg-neutral-900 rounded-t relative group">
                  ...
                  />
                  <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-neutral-900 px-2 py-1 rounded text-xs text-yellow-500 font-semibold whitespace-nowrap border border-neutral-800">
                    {prefix}{point.value.toFixed(1)}{suffix}
                  </div>
                </div>
