        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            {isTrialActive && !isSubscriptionActive && (
              <div className="flex items-center space-x-2 bg-yellow-500/10 border border-yellow-500/30 px-3 py-2 rounded-lg">
            ...
            {isActive() && activeProduct && (
              <div className="flex items-center space-x-2 bg-green-500/10 border border-green-500/30 px-3 py-2 rounded-lg">
            ...
            <button
              ...
              className="text-neutral-300 hover:text-yellow-500 transition-colors font-medium"
            >
              Dashboard
            </button>
            <button
